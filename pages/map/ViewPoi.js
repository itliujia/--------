Page({
    ...
    onLoad: function(a) {
        var t = this;
        getApp().SetColor(this), wx.showLoading({
            title: "加载中..."
        }), wx.request({
            ...
            success: function(a) {
                if (console.log(a.data), "1" == a.data.msg) {
                    ...
                    t.setData({
                        SatImg: "http://apis.map.qq.com/ws/staticmap/v2/?center=" + o[0].latitude + "," + o[0].longitude + "&zoom=17&size=270*480&maptype=satellite&key=UBHBZ-G7PKO-H4VWE-SRWOE-SS6NO-YOBSD",
                        poi: o[0]
                    }), wx.hideLoading();
                }
            }
